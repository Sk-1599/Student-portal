...
def notes(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            notes.save()  # saves data in the table
...
def delete_note(request, pk=None):
    # pk is primary key when we click on delete icon specific id gets deleted
...
def todo(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            todos.save()
            messages.success(
                request, f'TO-DO Added from {request.user.username} successfully!!')
    else:
        form = TodoForm()
